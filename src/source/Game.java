...
public class Game extends Canvas implements Runnable{
	...
	private final int WIDTH = 600, HEIGHT = 600; // window dimensions
	private final String TITLE = "Gotta be quick"; //window title
	...
	public Game(){
		...
		handler.addObject(new Ball(270, 240, ID.Ball, true));
